...
while materials and magic:
    ...
    if total_magic is points:
        make_present = points[total_magic]
        if make_present not in presents:
            presents[make_present] = 0
        presents[make_present] += 1

        materials.pop()
        magic.popleft()
    elif total_magic < 0:
        # the sum is appended to our materials
